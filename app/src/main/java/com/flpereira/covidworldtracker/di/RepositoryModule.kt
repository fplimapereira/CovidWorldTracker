...
object RepositoryModule {
    ...
    fun provideRepository(
        ...
        countriesListNetworkMapper: CountriesListNetworkMapper): Repository{
        return Repository(worldCasesDataDao, retrofit, cacheMapper, worldDataNetworkMapper, countriesListNetworkMapper)
    }
}